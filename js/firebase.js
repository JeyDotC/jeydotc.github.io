(function() {
    ...
    function ic(a, b, c) {
        ...
        var f = c ? dc : ec;
        a.sort(f);
        var h, f = new kc(a.length), i = l, m = l, n = a.length;
        for (h = 0; h < f.count; ++h) {
            var p = !(f.td & 1 << f.Xc);
            f.Xc--;
    ...
    T.prototype.open = function(a, b) {
        ...
        this.Y.onmessage = function(a) {
            if (c.Y !== l)
                if (a = a.data, sc(c.$, "bytes_received", a.length), Ac(c), c.frames !== l)
                    Bc(c, a);
                else {
                    a:{
                    ...
                    if ("c" == d) {
                        if (d = Vb("t", c), "d"in c)
                            if (c = c.d, "h" === d) {
                                ...
                                a.gc = c.s;
                                rb(a.K, f);
                                if (0 == a.va && (a.L.start(), c = a.L, a.e("Realtime connection established."), a.L = c, a.va = 1, a.yb && (a.yb(d), a.yb = l), "5" !== e && N("Protocol version mismatch detected"), c = 1 < a.Tc.ic.length ? a.Tc.ic[1] : l))
                                ...
                                "s" === d ? (a.e("Connection shutdown command received. Shutting down..."), a.Fc && (a.Fc(c), a.Fc = l), a.R = l, a.close()) : "r" === d ? (a.e("Reset packet received.  New host: " + c), rb(a.K, c), 1 === a.va ? a.close() : (Tc(a), Pc(a))) : "e" === d ? Qb("Server Error: " + c) : Qb("Unknown control packet command: " + d)
                    } else
                        "d" == d && a.Vb(c)
                } else
                    b === a.A ? (d = Vb("t", c), c = Vb("d", c), "c" == d ? "t"in c && (c = c.t, "a" === c ? (a.A.start(), a.e("sending client ack on secondary"), a.A.send({t: "c", d: {t: "a",
                            d: {}}}), a.e("Ending transmission on primary"), a.L.send({t: "c", d: {t: "n", d: {}}}), a.Kb = a.A, Sc(a)) : "r" === c && (a.e("Got a reset on secondary, closing it"), a.A.close(), (a.Kb === a.A || a.Ib === a.A) && a.close())) : "d" == d ? a.Yb.push(c) : g(Error("Unknown protocol layer: " + d))) : a.e("message on old connection")
        }
    }
    ...
    s.dd = function() {
        ...
        0 === this.Ab && (this.U = []);
        if (this.Na)
            this.hb ? this.rb && (3E4 < (new Date).getTime() - this.rb && (this.pa = 1E3), this.rb = l) : (this.e("Window isn't visible.  Delaying reconnect."), this.pa = 3E5, this.Cc = (new Date).getTime()), a = Math.max(0, this.pa - ((new Date).getTime() - this.Cc)), a *= Math.random(), this.e("Trying to reconnect in " +
    ...
    function ud(a, b, c, d, e) {
        ...
        for (var h = 0; h < f.length; h++)
            if (f[h].type === b) {
                ...
                f[h].aa && (i = i.F(f[h].aa));
                d.push({W: e ? w(c, e) : c, md: new S(f[h].sa, i), Eb: f[h].Eb})
            }
        rd(a.uc, d)
    }
    ...
    function wd(a, b) {
        for (var c = [], d = 0; d < b.length; d++) {
            ...
            for (f = 0; f < a.ma.length; f++) {
                var i = a.ma[f];
                b[d].type === i.type && c.push({W: i.T ? w(i.W, i.T) : i.W, md: h, Eb: e.Eb})
            }
        }
        rd(a.uc, c)
    }
    ...
    function Dd(a, b, c, d, e) {
        ...
        O = d.Va();
        for (G = Wa(O); I !== l || G !== l; ) {
            c = I === l ? 1 : G === l ? -1 : I.key === G.key ? 0 : dc({name: I.key, ha: I.value.j()}, {name: G.key, ha: G.value.j()});
            if (0 > c)
                f = ua(q, I.key), u(f) ? (n.push({wc: I, Qc: i[f]}), i[f] = l) : (t[I.key] = m.length, m.push(I)), f = k, I = Wa(x);
            else {
                if (0 < c)
                    f = ua(t, G.key), u(f) ? (n.push({wc: m[f], Qc: G}), m[f] = l) : (q[G.key] = i.length, i.push(G)), f = k;
                else {
                    c = b.F(G.key);
                    if (c = Cd(a, c, I.value, G.value))
                        p.push(G), f = k;
                    I.value.j() !==
                            G.value.j() && (n.push({wc: I, Qc: G}), f = k);
                    I = Wa(x)
                }
                G = Wa(O)
            }
        ...
        for (h = 0; h < m.length; h++)
            if (q = m[h])
                c = b.F(q.key), Cd(a, c, q.value, P), e.push(new W("child_removed", q.value, q.key));
        for (h = 0; h < i.length; h++)
            if (q = i[h])
                c = b.F(q.key), m = d.da(q.key, q.value), Cd(a, c, P, q.value), e.push(new W("child_added", q.value, q.key, m));
    ...
    Hd.prototype.ac = function(a, b) {
        ...
        for (t = 0; t < n.length; t++)
            c = n[t], x = this.i.da(c.aa, c.sa), m.push(new W("child_added",
                    c.sa, c.aa, x));
    ...
    function Sd(a, b, c, d, e) {
        var f = b.path(), b = a.lb(f, b, d, e), h = P, i = [];
        Yb(b, function(b, n) {
            var p = new K(n);
            3 === b || 1 === b ? h = h.G(n, d.Q(p)) : (2 === b && i.push({path: f.F(n), oa: P}), i = i.concat(Td(a, d.Q(p), L(c, p), e)))
        });
        return[{path: f, oa: h}].concat(i)
    }
    function Ud(a, b, c, d) {
        var e;
        a:{
    ...
    function Td(a, b, c, d) {
        var e = c.k();
        if (e !== l)
            return Fd(e) ? [{path: c.path(), oa: b}] : Sd(a, e, c, b, d);
        var f = [];
        c.w(function(c) {
    ...
    s.eb = function(a, b, c, d) {
        ...
        var e = $d(this), b = R(b, c), e = Wd(b, e), e = Ud(this.H, a, e, this.g.I), f = this.g.set(a, e), h = this;
    ...
    s.update = function(a, b, c) {
        ...
        for (m in b) {
            var e = o, n = R(b[m]), n = Wd(n, h), d = d.G(m, n), p = a.F(m);
            f.push(p);
            n = Ud(this.H, p, n, this.g.I);
            i = i.concat(this.g.set(a, n))
        }
        if (e)
            Nb("update() called with empty data.  Don't do anything."), X(c, "ok");
        else {
            var q = this;
    ...
    $.prototype.update = function(a, b) {
        ...
        for (f in a)
            e = o;
        if (e)
            Nb("onDisconnect().update() called with empty data.  Don't do anything."), X(b, k);
        else {
            e = c.u;
            f = d.toString();
            var h = function(e) {
            ...
            e.P ? ed(e, "om", f, a, h) : e.xb.push({Jc: f, action: "om",
                data: a, C: h})
        }
    };
        ...
        if (arguments[0]instanceof Xd)
            ...
            if (v(d)) {
                ...
                if (3 == m.length) {
                    ...
                    e = 0 <= h ? "https" === i : k;
                    if ("firebase" === m[1])
                        Rb(a + " is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead");
                    else {
                        b = m[0];
                        f = "";
                        d = ("/" + d).split("/");
    ...
    J.prototype.transaction = function(a, b, c) {
        ...
        var i =
                new J(e, f);
        i.Ya("value", d);
        var h = {path: f, update: a, C: b, status: l, ed: Hb(), nc: h, kd: 0, kc: function() {
                i.vb("value", d)
            }, lc: l}, m = h.update(U(e.gb, f).V());
        if (u(m)) {
